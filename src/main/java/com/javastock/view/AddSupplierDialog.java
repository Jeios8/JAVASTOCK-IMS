...
public class AddSupplierDialog extends JDialog {
    ...
    public AddSupplierDialog(JFrame parent, SupplierVM viewModel) {
        ...
        nameField = createRoundedTextField("Enter supplier name...");
        ...
        addButton = createRoundedButton("Add Supplier", new Color(0, 123, 255));
    ...
    private void addSupplier() {
        boolean success = viewModel.addSupplier(
                nameField.getText(),
        ...
        if (success) {
            ...
            JOptionPane.showMessageDialog(this, "Invalid input or failed to add supplier.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
}